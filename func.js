...
function handleDragOver(event) {
  ...
  function getDragAfterElement(sectionsList, y) {
    ...
    function toggleSection(sectionId) {
        ...
        // if (sectionElement) {
        //   const checkboxElement = sectionElement.querySelector('input[type="checkbox"]');
        //   if (checkboxElement) {
      ...
      function showDescription(sectionId) {
        ...
        if (sectionDescriptionElement) {
          sectionDescriptions.classList.remove('hidden');
          Array.from(sectionDescriptions.children).forEach((child) => {
            child.classList.add('hidden');
          });
          sectionDescriptionElement.classList.remove('hidden');
        }
      }
